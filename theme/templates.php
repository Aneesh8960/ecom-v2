...
<body style="background-color:white" onload="totalprice()" >
  ...
  <header id="header"><!--header-->
          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                <li><a href="#"><i class="fa fa-phone"></i> +91 88 400 78 271</a></li>
                <li><a href="#"><i class="fa fa-envelope"></i> aneeshkumar8960@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-sm-7">
            <div class="col-sm-6">
              <div class="video-gallery text-center">
                <a href="#">
                    <iframe class="iframe-img"  src="https://www.youtube.com/embed/kA9XWvkgAAU"   allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </a>
              </div>
            </div>
            ...
            <div class="col-sm-6">
              <div class="video-gallery text-center">
                <a href="#">
                   <iframe  class="iframe-img"  src="https://www.youtube.com/embed/kA9XWvkgAAU" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </a>
              </div>
            </div>
          </div>
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <p class="pull-left">Modified by <span><a href="https://bit.ly/2LPn9Wu">Aneesh kumar Source Code</a></span></p>
          <p class="pull-right">Designed by <span><a target="_blank" href="http://redstoreecom.epizy.com">Anees'Team</a></span></p>
        </div>
      </div>
    </div>
